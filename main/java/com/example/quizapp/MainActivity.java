    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        easy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                medium.setBackgroundResource(R.drawable.difficulty);
                hard.setBackgroundResource(R.drawable.difficulty);
            }
        });
        ...
        medium.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                easy.setBackgroundResource(R.drawable.difficulty);
                hard.setBackgroundResource(R.drawable.difficulty);
            }
        });
        ...
        topic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedDifficultyLevel.isEmpty()){
                    ...
                    intent.putExtra("selectedDiff", selectedDifficultyLevel);
