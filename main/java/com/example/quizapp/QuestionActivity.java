...
public class QuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView selectedTopic = findViewById(R.id.topicN);
        ...
        questionsLists = QuestionBank.getQuestion(getSelectedTopic);

        startTimer(timerLayout);
        ...
        option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedOptionByUser.isEmpty()){
                    ...
                    option1.setBackgroundResource(R.drawable.round_black_red);
        ...
        option2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedOptionByUser.isEmpty()){
                    ...
                    option2.setBackgroundResource(R.drawable.round_black_red);
        ...
        option3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedOptionByUser.isEmpty()){
                    ...
                    option3.setBackgroundResource(R.drawable.round_black_red);
        ...
        option4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedOptionByUser.isEmpty()){
                    ...
                    option4.setBackgroundResource(R.drawable.round_black_red);
    ...
    private int getCorrectAnswers(){
        ...
        for(int i=0;i<questionsLists.size();i++){
            ...
            final String getAnswers = questionsLists.get(i).getAnswer();

            if(getUserSelectedAnswer.equals(getAnswers)){
                correctAnswers++;
            }
        }
